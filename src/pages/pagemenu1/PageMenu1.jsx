...
vers un médecin ou tout professionnel compétent en la matière.
      ...
      <div className="allCards">
        <CardsServices
          ...
          services2="*facture fournie pour prise en charge mutuelle"
        ...
        <CardsServices
          ...
          En cure, avec la mise en place d'une alimentation anti-inflammatoire en cas de blessure ou
          affection par exemple, ou d'un régime hypotoxique, des conseils en gestion des indices
          glycémiques...etc.
          En optimisation, avec un accompagnement unique ou suivi, pour maintenir vos
